...
public extension String {
    ...
    func localizedPlural(_ argument: CVarArg) -> String {
        if Localize.currentLanguage() == "ru" {
            return NSString.localizedStringWithFormat(pluralRussian(argument).localized() as NSString, argument) as String
        }
    ...
    private func pluralRussian(_ argument: CVarArg) -> String {
        var newLocalize: String = self
        if argument is Int {
            let value: Int = argument as! Int
            if value % 10 == 1 && value % 100 != 11 {
                newLocalize = "\(self)_one"
            } else if value % 10 >= 2 && value % 10 <= 4 && (value % 100 < 12 || value % 100 > 14) {
                newLocalize = "\(self)_few"
            } else if value % 10 == 0 || (value % 10 >= 5 && value % 10 <= 9) || (value % 100 >= 11 && value % 100 <= 14) {
                newLocalize = "\(self)_many"
            }
        }
